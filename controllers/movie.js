...
exports.createMovie = async (req, res) => {
  ...
  if(writers){
    for(let writersId of writers){
        if(!isValidObjectId(writersId)) return sendError(res,'Invalid writers ID!')
    }
    ...
    exports.removeMovie = async (req,res)=>{
      ...
      if(!trailerId) return sendError(res,'Could not found trailer from cloud!')
      ...
      res.json({message:'Movie remove successfully'})
